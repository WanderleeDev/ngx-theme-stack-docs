...
:::warning
Si cambias la estrategia manualmente, **debes** ejecutar el comando de sincronización para actualizar el script de bloqueo inyectado en tu `index.html`. En la mayoría de las configuraciones, esto se maneja de forma automática mediante hooks de scripts de tu gestor de paquetes.
:::
...
(function() {
  try {
    ...
    var m = "tu-mode";
    var v = ["light", "dark", "system", "tus-temas-personalizados"];
    var t = localStorage.getItem(k) || d;
    var e = document.documentElement;

    // Validación de seguridad (asegura formato correcto y que el tema esté configurado)
