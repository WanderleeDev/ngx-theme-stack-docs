...
<Badge text="ngx-theme-stack" class="badge-angular" /> already includes exhaustive tests for all its utilities. As a developer, your goal should be to test **your own components** and how they react to theme changes, rather than the internal logic of the library.
